...
The 'learning_toolkit' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/learning_toolkit/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] learning_toolkit_etl` to your workspace.
